      ...
      >
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.pageSub}>
            Refine your physical metrics and set intentions for your daily
            vitality.
          </Text>
        </View>
            ...
            >
              ...
              {item.connected !== null ? (
                <TouchableOpacity
                  style={[
                    styles.toggle,
                    ecoToggles[item.id] && styles.toggleOn,
                  ]}
        ...
        <Text style={styles.footerNote}>
          Your data is stored locally and encrypted. We never share your health
          metrics without permission.
        </Text>
      </ScrollView>
